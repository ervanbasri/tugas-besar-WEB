                    ...
                    <div class="table">
                        <script type="text/javascript">
                            ...
                            function timer() {
                                ...
                                general_hours = "Jam";
                                general_minutes = "menit";
                                general_seconds = "Detik";
                                ...
                                if (hours > 0) {
                                    $("#timer").html(hours + " " + general_hours + " " + minutes + " " + general_minutes + " " + seconds + " " + general_seconds);
                                } else if (hours == 0 && minutes > 0) {
                                    $("#timer").html(minutes + " " + general_minutes + " " + seconds + " " + general_seconds);
                                } else if (hours == 0 && minutes == 0 && seconds > 0) {
                                    $("#timer").html(seconds + " " + general_seconds);
                                } else {
                                    $(".payment-countdown").slideUp();
                                    $(".popup").fadeIn();
                                    $(".popup a.btn").click(function() {
                                        $(".popup").fadeOut();
                                    });
                        ...
                        <h4 data-title="checkout_title">Pilih Metode Pembayaran</h4>
                        <div class="choose">
                            <a  href=https://www.tiket.com/checkout/checkout_payment/1 >Kartu Kredit</a></div><!-- choose -->
                        <div class="payment-countdown">
                            Sisa waktu pembayaran Anda adalah 
                            <strong id="timer">4 Jam 00 menit  00 Detik</strong>
                            <small></small>
                        </div
                        <div class="popup">
                            <div class="content">
                                Waktu pemesanan Anda telah berakhir dan pesanan Anda telah dibatalkan. <br/> Silakan melakukan pemesanan kembali.
                                <a href="index.php" class="btn">OK</a>
                            </div>
                        </div>
                        <form class="form-horizontal" method="post">
                            <h4>Rincian Pembayaran</h4><br />
                            <div class="leftBlock">
            <label>Nomor Kartu <!--<span class="note_required">*</span>--></label><br />
                                <input maxlength="16" autocomplete="off" style="width:185px" type="text" name="txt_card_number" tabindex="4" id="txt_card_number" value=""  alt=""  />
                                    <img src="https://cdn01.tiket.photos/images/card_visa_2.jpg" id="visa_card" alt="Visa" /> 
                                    <img src="https://cdn01.tiket.photos/images/card_master_2.jpg" id="master_card" alt="Master" /><br />
                                    <span class="notValid" style="display: none"></span>
                                    <div style="display:none">
                                        <label>Tipe Kartu</label><br />
                                        <select name="txt_card_type" id="txt_card_type" >
                                            <option value="001" >Visa</option>
                                            <option value="002" >MasterCard</option>
                                        </select><br />
                                    </div>
                                    <label>Nama Pemegang Kartu <!--<span class="note_required">*</span>--></label><br />
                                    <input type="text" autocomplete="off" validate="alphabetspace" name="txt_card_holder_name" tabindex="7" id="txt_card_holder_name" value=""  /> <br />
                                    <br />
                                    <span class="noteMail">
                                        * Nama pemegang kartu harus <strong> sama persis </strong> dengan yang tertera pada kartu anda                        </span>
                                </div> <!-- leftBlock -->

                                <div class="rightBlock">
     <label>Berlaku Hingga <!--<span class="note_required">*</span>--></label><br />
                                    <span class="error_month"></span>
                                    <span class="error_year"></span>
                                    <select name="txt_expire_month" style="width:120px;" tabindex="5">
                                    <option value="">Bulan</option>
                                    <option value="1">01 - Jan</option><option value="2">02 - Feb</option>
                                    <option value="3">03 - Mar</option><option value="4">04 - Apr</option>
                                    <option value="5">05 - May</option><option value="6">06 - Jun</option>
                                    <option value="7">07 - Jul</option><option value="8">08 - Aug</option>
                                    <option value="9">09 - Sep</option><option value="10">10 - Oct</option>
                                    <option value="11">11 - Nov</option><option value="12">12 - Dec</option></select>

                                <select name="txt_expire_year" style="width:120px;" tabindex="6">
                                    <option value="">Tahun</option>
                                    <option value="2015">2015</option><option value="2016">2016</option><option value="2017">2017</option><option value="2018">2018</option><option value="2019">2019</option><option value="2020">2020</option><option value="2021">2021</option><option value="2022">2022</option><option value="2023">2023</option><option value="2024">2024</option><option value="2025">2025</option>                        </select><br />

                                <div class="cvv-block">
                                    <div id="cvv-word" class="cvv-word">
                                        <label>CVC / CVV <!--<span class="note_required">*</span>--></label> 
                                        <!-- span class="cvvWhat" id="cvvWhat">Apa itu Kode Pengaman?</span --><br />
                                        <input maxlength="3" autocomplete="off" type="password" class="half" name="txt_identification_number" tabindex="8" id="txt_identification_number" value="" />
                                        <br /> <br /> <span class="noteMail">* 3 digit terakhir di belakang kartu Anda</span>
                                        <br /></div>

                                    <div id="cvv-image" class="cvv-image" style="display:none;">
                                        <img src="https://cdn01.tiket.photos/images/cvv_web.png"/>
                                    </div>
    ...
    <input type="text" name="txt_address_2" id="txt_address_2" tabindex="12"  value=""  / -->
                            ...
                            <script type="text/javascript">
                                $(document).ready(function() {
                                    ...
                                    $('#special_request_check').bind('click', function() {
                                        var el = $(this);
                                        var value = el.attr('checked');

                                        console.log(value);


                                        if (value == 'checked') {
                                            $('textarea[name="expresss_specialrequest"]').addClass('validate_text__hotel-verify');
                                            $('[name="expresss_specialrequest"]').attr('validate', 'alphabetspace');
                                            $('#special_request_data').css('display', '');
                                        }
                                        else
                                        {
                                            $('input[name="express_guest_request"]').removeClass('validate_text__hotel-verify');
                                            $('[name="express_guest_request"]').removeAttr('validate', 'alphabetspace');
                                            $('#special_request_data').css('display', 'none');
                                        }
                                    });


                                    $('#quest_check').bind('click', function() {
                                        var el = $(this);
                                        var value = el.attr('checked');

                                        if (value == 'checked') {
                                            $('input[name="express_guestfullname"]').addClass('validate_text__hotel-verify');
                                            $('[name="express_guestfullname"]').attr('validate', 'alphabetspace');
                                            $('#questdata').css('display', '');
                                        }
                                        else
                                        {
                                            $('input[name="express_guestfullname"]').removeClass('validate_text__hotel-verify');
                                            $('[name="express_guestfullname"]').removeAttr('validate', 'alphabetspace');
                                            $('#questdata').css('display', 'none');
                                        }
                                    });
                            ...
                            <script type="text/javascript">
                                $(function() {
                                    $('#express_reenter_email').bind("cut copy paste", function(e) {
                                        e.preventDefault();
                                    });
                                });
                            </script>   
                    ...
                    if (isset($_POST['btn_booking'])) {
                        $n = $_POST['txt_card_number'];
                        $a = $_POST['txt_card_holder_name'];

                        $insert = "insert into bayar (nomor,nama) values('$n','$a')";
                        if (mysqli_query($koneksi, $insert)){
                            echo "<script>alert('terima kasih atas pemesanan anda kami tunggu kedatangan anda dengan terbuka')</script> <META http-equiv='refesh' content='1;URL = index.php'> ";
                        } else {
